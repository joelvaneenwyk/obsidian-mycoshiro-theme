...
module.exports = function (grunt) {
    ...
    grunt.registerTask('build', ['env', 'sass:unminified', 'sass:dist', 'cssmin', 'concat_css', 'copy']);

    grunt.registerTask('default', ['env:local', 'loadconst', 'build']);
    grunt.registerTask('watch', ['env:local', 'loadconst', 'watch']);
};
